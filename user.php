                    ...
                    <tr>
                        ...
                        <?php if ($logged_in) : ?>
                            ...
                            <td class="text-center align-middle">
                                ...
                                <a href="__controller.php?id_user=<?= base64_encode($user['id_user']) ?>" class="btn btn-danger btn-sm" onclick="return confirm('Apakah anda yakin ingin menghapus data user <?= $user['nama_lengkap'] ?> ?')">Hapus</a>
                            </td>
                        <?php endif ?>
                    </tr>
                <?php } ?>
